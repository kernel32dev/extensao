...
const SERVICE_NAME: &str = "ProjetoDeExtensao";
const DISPLAY_NAME: &str = "Projeto de Extensão";
const DESCRIPTION: &str = "Projeto do ifpi, do germano";
